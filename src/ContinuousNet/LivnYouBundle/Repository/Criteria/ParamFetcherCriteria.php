...
class ParamFetcherCriteria extends BaseCriteria
{
    ...
    public function apply($qBuilder, BaseRepository $repository)
    {
        ...
        $offset = $this->paramFetcher->get('offset');
        ...
        $orderBy = $this->paramFetcher->get('order_by') ? $this->paramFetcher->get('order_by') : array();
