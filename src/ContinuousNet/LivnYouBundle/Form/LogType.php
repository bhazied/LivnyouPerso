...
class LogType extends AbstractType
{
    ...
    {
        $builder
            ->add('session', EntityType::class, array('expanded' => false, 'multiple' => false, 'class' => 'LivnYouBundle:Session', 'choice_label' => 'ip'))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'ContinuousNet\LivnYouBundle\Entity\Log'
        ));
    }
