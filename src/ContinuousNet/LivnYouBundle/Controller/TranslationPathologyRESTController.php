...
use ContinuousNet\LivnYouBundle\Entity\TranslationPathology;
use ContinuousNet\LivnYouBundle\Form\TranslationPathologyType;
...
class TranslationPathologyRESTController extends BaseRESTController
{
    ...
    public function postAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            return $this->getDoctrine()->getRepository('LivnYouBundle:TranslationPathology')->store($entity, ['creatorUser' => $this->getUser()]);
        }
    ...
    public function putAction(Request $request, $id)
    {
        try {
            ...
            $form->submit($request->request->all());
            if ($form->isValid()) {
                return $this->getDoctrine()->getRepository('LivnYouBundle:TranslationPathology')->update($entity, ['modifierUser' => $this->getUser()]);
            }
