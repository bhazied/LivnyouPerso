...
class DashboardRestController extends BaseRESTController
{
    ...
    public function getDataAction()
    {
        ...
        $data['countUsers'] = $this->getDoctrine()->getRepository('LivnYouBundle:User')->countAll();
        $data['countGroups'] = $this->getDoctrine()->getRepository('LivnYouBundle:Group')->countAll();
        $data['countMeasurements'] = $this->getDoctrine()->getRepository('LivnYouBundle:Measurement')->countAll();
        return $data;
    }
}
